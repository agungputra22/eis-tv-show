window.HISTORICAL_VIOLANCE = (function($) {

    return {

        elTable : '#datatables',
        elTableServer : '#datatable_ajax',
        urlGetData : window.APP.siteUrl + 'historical_violance/datalist',

        elPortlet : '.portlet',
        elForm : '.form-historical_violance',
        elBtnList : '.btnList',
        ...
        initLoad : function(btn) {
            var url = window.APP.siteUrl + 'historical_violance/index';
