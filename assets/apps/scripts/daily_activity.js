window.DAILY_ACTIVITY = (function($) {

    return {

        elTable : '#datatables',
        elTableServer : '#datatable_ajax',
        urlGetData : window.APP.siteUrl + 'daily_activity/datalist',

        elPortlet : '.portlet',
        elForm : '.form-daily_activity',
        elBtnList : '.btnList',
        ...
        initLoad : function(btn) {
            var url = window.APP.siteUrl + 'daily_activity/index';
