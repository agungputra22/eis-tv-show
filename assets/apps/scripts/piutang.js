window.PIUTANG = (function($) {

    return {

        elTable : '#datatables',
        elTableServer : '#datatable_ajax',
        urlGetData : window.APP.siteUrl + 'piutang/datalist',

        elPortlet : '.portlet',
        elForm : '.form-piutang',
        elFormDetail : '.form-piutang-detail',
        elBtnList : '.btnList',
        ...
        handleSendDataDetail : function(FormName, Redirect = false) {
            var parentThis = this;
        ...
        initLoad : function(btn) {
            var url = window.APP.siteUrl + 'piutang/index';
