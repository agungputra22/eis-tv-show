window.PTK = (function($) {
    ...
    return {
        ...
        urlGetData : window.APP.siteUrl + 'ptk/datalist',
        ...
        handleApproveData : function() {
            ...
            $(parentThis.elBtnApprove).click(function() {
                if(confirm('Apakah anda ingin approve pengajuan PTK ?')) {
                    $.ajax({
                        url : $(this).data('url'),
                        type : 'post',
                        dataType : 'json',
        ...
        initLoad : function(btn) {
            var url = window.APP.siteUrl + 'ptk/index';
            Layout.loadAjaxContent(url, btn);
        },

        initLoadApprove : function(btn) {
            var url = window.APP.siteUrl + 'ptk/approve';
            Layout.loadAjaxContent(url, btn);
        },
