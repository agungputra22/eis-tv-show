window.ABSENSI_MASUK = (function($) {

    return {

        elTable : '#datatables',
        elTableServer : '#datatable_ajax',
        urlGetData : window.APP.siteUrl + 'absensi_masuk/datalist',

        elPortlet : '.portlet',
        elForm : '.form-absensi_masuk',
        elBtnList : '.btnList',
        ...
        initLoad : function(btn) {
            var url = window.APP.siteUrl + 'absensi_masuk/index';
