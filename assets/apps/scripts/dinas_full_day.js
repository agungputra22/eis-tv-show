window.DINAS_FULL_DAY = (function($) {

    return {

        elTable : '#datatables',
        elTableServer : '#datatable_ajax',
        urlGetData : window.APP.siteUrl + 'dinas_full_day/datalist',

        elPortlet : '.portlet',
        elForm : '.form-dinas_full_day',
        elBtnList : '.btnList',
        ...
        initLoad : function(btn) {
            var url = window.APP.siteUrl + 'dinas_full_day/index';
