window.PEMBINAAN_KARYAWAN = (function($) {

    return {

        elTable : '#datatables',
        elTableServer : '#datatable_ajax',
        urlGetData : window.APP.siteUrl + 'pembinaan_karyawan/datalist',

        elPortlet : '.portlet',
        elForm : '.form-pembinaan_karyawan',
        elBtnList : '.btnList',
        ...
        initLoad : function(btn) {
            var url = window.APP.siteUrl + 'pembinaan_karyawan/index';
