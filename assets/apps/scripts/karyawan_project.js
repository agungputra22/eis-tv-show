window.KARYAWAN_PROJECT = (function($) {

    return {

        elTable : '#datatables',
        elTableServer : '#datatable_ajax',
        urlGetData : window.APP.siteUrl + 'karyawan_project/datalist',

        elPortlet : '.portlet',
        elForm : '.form-karyawan_project',
        elBtnList : '.btnList',
        ...
        initLoad : function(btn) {
            var url = window.APP.siteUrl + 'karyawan_project/index';
