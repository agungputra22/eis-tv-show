window.HISTORICAL_PKWT = (function($) {

    return {

        elTable : '#datatables',
        elTableServer : '#datatable_ajax',
        urlGetData : window.APP.siteUrl + 'historical_pkwt/datalist',

        elPortlet : '.portlet',
        elForm : '.form-historical_pkwt',
        elBtnList : '.btnList',
        ...
        initLoad : function(btn) {
            var url = window.APP.siteUrl + 'historical_pkwt/index';
