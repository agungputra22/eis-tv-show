window.DINAS_NON_FULL = (function($) {

    return {

        elTable : '#datatables',
        elTableServer : '#datatable_ajax',
        urlGetData : window.APP.siteUrl + 'dinas_non_full/datalist',

        elPortlet : '.portlet',
        elForm : '.form-dinas_non_full',
        elBtnList : '.btnList',
        ...
        initLoad : function(btn) {
            var url = window.APP.siteUrl + 'dinas_non_full/index';
