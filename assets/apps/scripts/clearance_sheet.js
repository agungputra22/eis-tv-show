window.CLEARANCE_SHEET = (function($) {

    return {

        elTable : '#datatables',
        elTableServer : '#datatable_ajax',
        urlGetData : window.APP.siteUrl + 'clearance_sheet/datalist',

        elPortlet : '.portlet',
        elForm : '.form-clearance_sheet',
        elBtnList : '.btnList',
        ...
        initLoad : function(btn) {
            var url = window.APP.siteUrl + 'clearance_sheet/index';
