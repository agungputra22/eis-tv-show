window.SELF_COVID = (function($) {

    return {

        elTable : '#datatables',
        elTableServer : '#datatable_ajax',
        urlGetData : window.APP.siteUrl + 'self_covid/datalist',

        elPortlet : '.portlet',
        elForm : '.form-self_covid',
        elBtnList : '.btnList',
        ...
        initLoad : function(btn) {
            var url = window.APP.siteUrl + 'self_covid/index';
            Layout.loadAjaxContent(url, btn);
        },

        initLoadEssay : function(btn) {
            var url = window.APP.siteUrl + 'self_covid/index_essay';
            Layout.loadAjaxContent(url, btn);
        },

        initLoadEssaySpv : function(btn) {
            var url = window.APP.siteUrl + 'self_covid/index_essay_spv';
            Layout.loadAjaxContent(url, btn);
        },
