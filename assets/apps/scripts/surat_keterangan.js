window.SURAT_KETERANGAN = (function($) {

    return {

        elTable : '#datatables',
        elTableServer : '#datatable_ajax',
        urlGetData : window.APP.siteUrl + 'surat_keterangan/datalist',

        elPortlet : '.portlet',
        elForm : '.form-surat_keterangan',
        elBtnList : '.btnList',
        ...
        handleApproveData : function() {
            ...
            $(parentThis.elBtnApprove).click(function() {
                if(confirm('Apakah anda ingin approve pengajuan SK ?')) {
                    $.ajax({
                        url : $(this).data('url'),
                        type : 'post',
                        dataType : 'json',
        ...
        initLoad : function(btn) {
            var url = window.APP.siteUrl + 'surat_keterangan/index';
            Layout.loadAjaxContent(url, btn);
        },

        initLoadApprove : function(btn) {
            var url = window.APP.siteUrl + 'surat_keterangan/approve';
            Layout.loadAjaxContent(url, btn);
        },
