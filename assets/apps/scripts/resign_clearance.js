window.RESIGN_CLEARANCE = (function($) {

    return {

        elTable : '#datatables',
        elTableServer : '#datatable_ajax',
        urlGetData : window.APP.siteUrl + 'resign_clearance/datalist',

        elPortlet : '.portlet',
        elForm : '.form-resign_clearance',
        elBtnList : '.btnList',
        ...
        initLoad : function(btn) {
            var url = window.APP.siteUrl + 'resign_clearance/index';
