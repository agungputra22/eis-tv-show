...
class Kalender extends CI_Controller {
	...
	public function index(){	
        if($this->input->is_ajax_request()):
            ...
            // $view = $this->load->view('admin/kalender/hasil_cari_nama', $data, TRUE);
    ...
    public function load_default(){
        if($this->input->is_ajax_request()):
			$d = array(
				'januari' => $this->_bikin_kalender(1,2024),
				'februari' => $this->_bikin_kalender(2,2024),
				'maret' => $this->_bikin_kalender(3,2024),
				'april' => $this->_bikin_kalender(4,2024),
				'mei' => $this->_bikin_kalender(5,2024),
				'juni' => $this->_bikin_kalender(6,2024),
				'juli' => $this->_bikin_kalender(7,2024),
				'agustus' => $this->_bikin_kalender(8,2024),
				'september' => $this->_bikin_kalender(9,2024),
				'oktober' => $this->_bikin_kalender(10,2024),
				'november' => $this->_bikin_kalender(11,2024),
				'desember' => $this->_bikin_kalender(12,2024),
			);
			$view =  $this->load->view('admin/kalender/default_content', $d, TRUE);
    ...
    public function doInput_lemburan()
    {
