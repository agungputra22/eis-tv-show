...
class Dinas_full_day extends CI_Controller {
	...
	public function index()
	{
		...
		$data['title'] = "Data Dinas Full Day";
		$nik_baru = users('nik_baru');
		$data['listdata'] = $this->m_query->dinas_full_day($nik_baru)->result_array();
		$this->load->view('admin/izin/dinas_full_day/index', $data);
	}
	...
	public function approve()
	{
		...
		if ($lokasi == 'Pusat') {
			...
			$data['title'] = "Data Approval Dinas Full Day";
			$nik_baru = users('nik_baru');
			$jabatan = users('jabatan_struktur');
			$data['listdata'] = $this->m_admin->index_dinas_full_day_pusat($jabatan)->result_array();
			$data['approve'] = $this->m_query->approve_dinas_full_day_level1_pusat($jabatan);
			$data['not_approve'] = $this->m_query->not_approve_dinas_full_day_level1_pusat($jabatan);
			$data['hangus'] = $this->m_query->hangus_dinas_full_day_level1_pusat($jabatan);
			$this->load->view('admin/izin/dinas_full_day/approve', $data);
		}
		...
		elseif ($nik == '1908000101') {
			...
			$jabatan = users('jabatan_struktur');
			$lokasi = users('lokasi_struktur');
			$data['listdata'] = $this->m_admin->index_dinas_full_day_case($jabatan, $lokasi)->result_array();
			$data['approve'] = $this->m_query->approve_dinas_full_day_level1($jabatan, $lokasi);
			$data['not_approve'] = $this->m_query->not_approve_dinas_full_day_level1($jabatan, $lokasi);
			$data['hangus'] = $this->m_query->hangus_dinas_full_day_level1($jabatan, $lokasi);
			$this->load->view('admin/izin/dinas_full_day/approve', $data);
		}
		elseif ($lokasi != 'Pusat' and $lokasi != 'Rancamaya') {
			...
			$jabatan = users('jabatan_struktur');
			$lokasi = users('lokasi_struktur');
			$data['listdata'] = $this->m_admin->index_dinas_full_day($jabatan, $lokasi)->result_array();
			$data['approve'] = $this->m_query->approve_dinas_full_day_level1($jabatan, $lokasi);
			$data['not_approve'] = $this->m_query->not_approve_dinas_full_day_level1($jabatan, $lokasi);
			$data['hangus'] = $this->m_query->hangus_dinas_full_day_level1($jabatan, $lokasi);
			$this->load->view('admin/izin/dinas_full_day/approve', $data);
	...
	public function approve_level_2()
	{
		...
		if ($lokasi == 'Pusat') {
			...
			$nik_baru = users('nik_baru');
			$jabatan = users('jabatan_struktur');
			$data['listdata'] = $this->m_admin->index_dinas_full_day_level_2_pusat($jabatan)->result_array();
			$data['approve'] = $this->m_query->approve_dinas_full_day_level2_pusat($jabatan);
			$data['not_approve'] = $this->m_query->not_approve_dinas_full_day_level2_pusat($jabatan);
			$this->load->view('admin/izin/dinas_full_day/approve_level_2', $data);
		}
		elseif ($lokasi == 'Rancamaya') {
			function DateToIndo($date) {
			$BulanIndo = array("Januari", "Februari", "Maret", "April",
		...
		elseif ($jabatan = '255' and $lokasi == 'Pandeglang') {
			...
			$jabatan = users('jabatan_struktur');
			$lokasi = users('lokasi_struktur');
			$data['listdata'] = $this->m_admin->index_dinas_full_day_level_2_case($lokasi)->result_array();
			$data['approve'] = $this->m_query->approve_dinas_full_day_level2($jabatan, $lokasi);
			$data['not_approve'] = $this->m_query->not_approve_dinas_full_day_level2($jabatan, $lokasi);
			$this->load->view('admin/izin/dinas_full_day/approve_level_2', $data);
		}
		elseif ($lokasi != 'Pusat' and $lokasi != 'Rancamaya') {
			function DateToIndo($date) {
			...
			$jabatan = users('jabatan_struktur');
			$lokasi = users('lokasi_struktur');
			$data['listdata'] = $this->m_admin->index_dinas_full_day_level_2($jabatan, $lokasi)->result_array();
			$data['approve'] = $this->m_query->approve_dinas_full_day_level2($jabatan, $lokasi);
			$data['not_approve'] = $this->m_query->not_approve_dinas_full_day_level2($jabatan, $lokasi);
			$this->load->view('admin/izin/dinas_full_day/approve_level_2', $data);
		}
	...
	{
		$data['title'] = "Form Dinas Full Day";
		$lokasi = users('lokasi_struktur');
		...
		$this->load->view('admin/izin/dinas_full_day/tambah', $data);
	}

	public function edit($id)
	{
		$data['title'] = "Approval Dinas Full Day (".$id.")";
		$data['edit'] = $this->m_admin->izin_full_day($id)->row_array();
		$this->load->view('admin/izin/dinas_full_day/tindakan', $data);
	}
	...
	public function edit_level_2($id)
	{
		$data['title'] = "Approval Dinas Full Day (".$id.")";
		$data['edit'] = $this->m_admin->izin_full_day($id)->row_array();
		$this->load->view('admin/izin/dinas_full_day/tindakan_level_2', $data);
	}
	...
	public function doInput()
	{
		...
		if($this->form_validation->run()===TRUE) {
			...
			$jenis_full_day = 'DN';
			$start_full_day = $this->input->post('start_full_day_dn');
			...
			for ($i=0; $i < count($start_full_day); $i++) { 
				...
				if ($jabatan == '255') {
		            ...
		            $this->email->subject('Informasi Pengajuan Dinas Full Day Karyawan');
			            ...
			            '
			                <html>
			                    <body>
			                        ...
			                        Sesuai dengan adanya pengajuan terkait <b>Dinas Luar Full Day</b>, maka bersama email ini kami sampaikan adanya tim Bapak / Ibu yang mengajukan izin dengan data berikut :<br><br>
			                        <table>
									    <tr>
									        <td>NAMA</td> <td>:</td>
	...
	public function view_approve_level_1()
	{
		...
		if ($lokasi == 'Pusat') {
			...
			$data['title'] = "Data Approved Dinas Full Day";
			$nik_baru = users('nik_baru');
			$jabatan = users('jabatan_struktur');
			$data['listdata'] = $this->m_admin->index_dinas_full_day_level_1_approve_pusat($jabatan)->result_array();
			$this->load->view('admin/izin/dinas_full_day/view_approve_level_1', $data);
		}
		if ($lokasi == 'Rancamaya') {
			function DateToIndo($date) {
			$BulanIndo = array("Januari", "Februari", "Maret", "April",
		...
		if ($lokasi != 'Pusat' and $lokasi != 'Rancamaya') {
			...
			$jabatan = users('jabatan_struktur');
			$lokasi = users('lokasi_struktur');
			$data['listdata'] = $this->m_admin->index_dinas_full_day_level_1_approve($jabatan, $lokasi)->result_array();
			$this->load->view('admin/izin/dinas_full_day/view_approve_level_1', $data);
		}
	}
	...
	public function view_not_approve_level_1()
	{
		...
		if ($lokasi == 'Pusat') {
			...
			$data['title'] = "Data Not Approved Dinas Full Day";
			$nik_baru = users('nik_baru');
			$jabatan = users('jabatan_struktur');
			$data['listdata'] = $this->m_admin->index_dinas_full_day_level_1_not_approve_pusat($jabatan)->result_array();
			$this->load->view('admin/izin/dinas_full_day/view_not_approve_level_1', $data);
		}
		if ($lokasi == 'Rancamaya') {
			function DateToIndo($date) {
			$BulanIndo = array("Januari", "Februari", "Maret", "April",
		...
		if ($lokasi != 'Pusat' and $lokasi != 'Rancamaya') {
			...
			$jabatan = users('jabatan_struktur');
			$lokasi = users('lokasi_struktur');
			$data['listdata'] = $this->m_admin->index_dinas_full_day_level_1_not_approve($jabatan, $lokasi)->result_array();
			$this->load->view('admin/izin/dinas_full_day/view_not_approve_level_1', $data);
		}
	}
	...
	public function view_hangus_level_1()
	{
		...
		if ($lokasi == 'Pusat') {
			...
			$nik_baru = users('nik_baru');
			$jabatan = users('jabatan_struktur');
			$data['listdata'] = $this->m_admin->index_dinas_full_day_level_1_hangus_pusat($jabatan)->result_array();
			$this->load->view('admin/izin/dinas_full_day/hangus_level_1', $data);
		}
		if ($lokasi == 'Rancamaya') {
			function DateToIndo($date) {
			$BulanIndo = array("Januari", "Februari", "Maret", "April",
		...
		if ($lokasi != 'Pusat' and $lokasi != 'Rancamaya') {
			...
			$jabatan = users('jabatan_struktur');
			$lokasi = users('lokasi_struktur');
			$data['listdata'] = $this->m_admin->index_dinas_full_day_level_1_hangus($jabatan, $lokasi)->result_array();
			$this->load->view('admin/izin/dinas_full_day/hangus_level_1', $data);
		}
	}
	...
	public function view_approve_level_2()
	{
		...
		if ($lokasi == 'Pusat') {
			...
			$nik_baru = users('nik_baru');
			$jabatan = users('jabatan_struktur');
			$data['listdata'] = $this->m_admin->index_dinas_full_day_level_2_approve_pusat($jabatan)->result_array();
			$this->load->view('admin/izin/dinas_full_day/view_approve_level_2', $data);
		}
		if ($lokasi == 'Rancamaya') {
			function DateToIndo($date) {
			$BulanIndo = array("Januari", "Februari", "Maret", "April",
		...
		if ($lokasi != 'Pusat' and $lokasi != 'Rancamaya') {
			...
			$jabatan = users('jabatan_struktur');
			$lokasi = users('lokasi_struktur');
			$data['listdata'] = $this->m_admin->index_dinas_full_day_level_2_approve($jabatan, $lokasi)->result_array();
			$this->load->view('admin/izin/dinas_full_day/view_approve_level_2', $data);
		}
	}
	...
	public function view_not_approve_level_2()
	{
		...
		if ($lokasi == 'Pusat') {
			...
			$nik_baru = users('nik_baru');
			$jabatan = users('jabatan_struktur');
			$data['listdata'] = $this->m_admin->index_dinas_full_day_level_2_not_approve_pusat($jabatan)->result_array();
		...
		if ($lokasi != 'Pusat' and $lokasi != 'Rancamaya') {
			...
			$jabatan = users('jabatan_struktur');
			$lokasi = users('lokasi_struktur');
			$data['listdata'] = $this->m_admin->index_dinas_full_day_level_2_not_approve($jabatan, $lokasi)->result_array();
			$this->load->view('admin/izin/full_day/view_not_approve_level_2', $data);
		}
	}
	...
	public function download($id){
	    ...
	    $file = './/uploads/izin/dinas_full_day/'.$fileinfo['upload_dinas_full_day'];
	...
	public function print_penugasan($id)
	{
		...
		$data['title'] = "Print Surat Penugasan (".$id.")";
		$data['edit'] = $this->m_admin->izin_full_day($id)->row_array();
		$query_nomor = $this->m_query->getPengajuanDinas(array('id_full_day'=>$id))->result_array();
		foreach ($query_nomor as $nomor) {
			$nik = $nomor['nik_full_day'];
			$no = $nomor['no_pengajuan_full_day'];
			$jabatan = $nomor['jabatan_full_day'];
			$lokasi = $nomor['lokasi_struktur'];
			$data['tgl_awal'] = $this->m_query->awal_surat_tugas($nik, $no)->row_array();
			$data['tgl_akhir'] = $this->m_query->akhir_surat_tugas($nik, $no)->row_array();
			if ($jabatan == '255') {
				$data['atasan'] = $this->m_query->karyawan_email_pusat($jabatan)->row_array();
			} elseif ($lokasi == 'Pusat') {
				$data['atasan'] = $this->m_query->karyawan_email_pusat($jabatan)->row_array();
			} elseif ($jabatan == '275' OR $jabatan == '276' OR $jabatan == '279' OR $jabatan == '304' OR $jabatan == '275' OR $jabatan == '310' OR $jabatan == '311' OR $jabatan == '326' OR $jabatan == '327' OR $jabatan == '333' OR $jabatan == '334' OR $jabatan == '419' OR $jabatan == '420' OR $jabatan == '421' OR $jabatan == '422' OR $jabatan == '423' OR $jabatan == '425' OR $jabatan == '426' OR $jabatan == '438' OR $jabatan == '439' OR $jabatan == '440' OR $jabatan == '441' OR $jabatan == '442') {
				$data['atasan'] = $this->m_query->karyawan_email_pusat($jabatan)->row_array();
			} else {
				$data['atasan'] = $this->m_query->karyawan_email_depo($lokasi, $jabatan)->row_array();
			}
		}
		$this->load->view('admin/izin/dinas_full_day/print_penugasan', $data);
	}
