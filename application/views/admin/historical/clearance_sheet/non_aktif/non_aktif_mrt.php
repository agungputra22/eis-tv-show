...
<body onload="window.print()">
        ...
        <tr>
            ...
            <small>
                <?php
                    ...
                    echo "<td colspan='4'><small>$no/HRD&QMS-MRT/SK/$romawi/$tahun<br></small></td>";
                ?>
            </small>
        </tr>
        <tr>
    ...
    <table>
        ...
        <tr>
            <td colspan="2">Sebagai salah satu persyaratan <b>Pencairan Saldo Jaminan Hari Tua BPJS Ketenagakerjaan</b>.<br> Dengan ini menerangkan bahwa:<br><br></td>
        </tr>
    </table>
    <table>
        <tr>
    ...
    <table>
        <tr>
            <td colspan="4">Adalah  benar  pernah  bekerja  di CV. Metro Raya Trans sejak tanggal <?php echo DateToIndo(date($edit['tanggal_bergabung_clearance'])); ?> Dan terhitung mulai tanggal <?php echo DateToIndo(date($edit['tanggal_resign_clearance'])); ?> yang bersangkutan <b>mengundurkan diri dan sudah tidak aktif bekerja</b> di CV. Metro Raya Trans.<br><br></td>
        </tr>
        ...
        <tr>
            <td colspan="3"><small>CV. Metro Raya Trans</small><br><br><br><br><br></td>
