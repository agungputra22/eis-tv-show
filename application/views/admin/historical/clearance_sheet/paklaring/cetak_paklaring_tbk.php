...
<body onload="window.print()">
        ...
        <tr>
            <small>
                <?php
                    ...
                    echo "<td colspan='4' align='center'><small>No. $no/HRD&QMS-TBK/SKK/$romawi/$tahun<br></small></td>";
                ?>
            </small>
        </tr>
        <tr>
    ...
    <table>
        <tr>
            <td class="justify">Adalah  benar  pernah  bermitra  di CV. Terang Berkat Karunia sejak tanggal <?php echo DateToIndo(date($edit['tanggal_bergabung_clearance'])); ?> Dan terhitung mulai tanggal <?php echo DateToIndo(date($edit['tanggal_resign_clearance'])); ?> yang bersangkutan mengundurkan diri dan sudah tidak aktif bermitra di CV. Terang Berkat Karunia.<br><br></td>
        </tr>

        <tr>
            <td>Demikian surat keterangan ini dibuat untuk dapat dipergunakan sebagaimana mestinya.<br><br><br><br><br><br></td> <br>
        </tr>

        <tr>
            <td align="right"><small>Bogor , ……………………</small></td>
        </tr>

        <tr>
            <td align="right"><small>CV. Terang Berkat Karunia<br><br><br><br><br></small></td>
        </tr>

        <tr>
            <td align="right"><u><small>IBRAHIM ADI SANTOSO</small></u></td>
        </tr>

        <tr>
            <td align="right"><small>Direktur</small></td>
        </tr>
    </table>
