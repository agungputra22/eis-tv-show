...
<body onload="window.print()">
    <table width="100%">
        <tr class="header">
            <td>
                <img width="80" height="70" src="<?php echo base_url($this->config->item('img_path').'logo_asa.jpeg') ?>">
            </td>
        ...
        <tr>
            <small>
                <?php
                    ...
                    echo "<td colspan='4' align='center'><small>No. $no/HRD&QMS-ASA/SKK/$romawi/$tahun<br></small></td>";
                ?>
            </small>
        </tr>
        <tr>
    ...
    <table>
        ...
        <tr>
            <td colspan="4" align="right"><small>Serang , ……………………</small></td>
        </tr>

        <tr>
            <td colspan="4" align="right"><small>PT. Adi Sukses Abadi<br><br><br><br><br></small></td>
        </tr>
