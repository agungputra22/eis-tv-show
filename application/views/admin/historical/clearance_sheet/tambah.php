    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            ...
            <div class="portlet-body">
                <form role="form" class="form-horizontal form-clearance_sheet" method="post" action="<?php echo site_url('clearance_sheet/doInput') ?>">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="nama_clearance" class="form-control" placeholder="Enter Nama Karyawan" readonly="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="jabatan_clearance" class="form-control" placeholder="Enter Jabatan" readonly="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="depo_clearance" class="form-control" placeholder="Enter Kantor Cabang" readonly="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="date" name="tanggal_bergabung_clearance" class="form-control" readonly="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="date" name="tanggal_resign_clearance" class="form-control" required="">
                            </div>
                        </div>
                        ...
                        <div class="card card-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="besar_pinjaman_fa" class="form-control" placeholder="Enter Nominal" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="date" name="tanggal_pinjaman_fa" class="form-control" placeholder="Enter Tanggal" >
                                </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="card card-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="no_esco_fa" class="form-control" placeholder="Enter No. Esco" >
                                </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="card card-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="besar_pembebanan_op" class="form-control" placeholder="Enter Nominal" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="date" name="tanggal_pembebanan_op" class="form-control" placeholder="Enter Tanggal" >
                                </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="card card-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="date" name="kembali_seragam" class="form-control" placeholder="Enter Nominal" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="qty_seragam" class="form-control" placeholder="Enter Jumlah" >
                                </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                            <input type="checkbox" name="mis_laptop" alt="Checkbox" value="laptop" data-toggle="collapse" data-target="#mis_laptop" aria-expanded="false" aria-controls="mis_laptop"> Laptop

                            <input type="checkbox" name="mis_komputer" alt="Checkbox" value="komputer" data-toggle="collapse" data-target="#mis_kom" aria-expanded="false" aria-controls="mis_kom"> Komputer

                            <input type="checkbox" name="mis_handphone" alt="Checkbox" value="Handphone" data-toggle="collapse" data-target="#mis_kom" aria-expanded="false" aria-controls="mis_hp"> Handphone

                            <input type="checkbox" name="mis_mouse" alt="Checkbox" value="Mouse" data-toggle="collapse" data-target="#mis_kom" aria-expanded="false" aria-controls="mis_mouse"> Mouse
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="card card-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="date" name="tanggal_kembali_kendaraan" class="form-control" placeholder="Enter Nominal" >
                                </div>
                            </div>
                        ...
                        <div class="card card-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="date" name="tanggal_kembali_id_card" class="form-control" placeholder="Enter Nominal" >
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                            <input type="checkbox" name="ketetapan_qo" alt="Checkbox" value="Ketetapan QO"> Ketetapan QO

                            <input type="checkbox" name="laporan_qo" alt="Checkbox" value="Laporan QO"> Laporan QO
                            <br>
                            <input type="checkbox" name="action_plan" alt="Checkbox" value="Action Plan"> Action Plan

                            <input type="checkbox" name="dokumen_smm" alt="Checkbox" value="Dokumen SMM"> Dokumen SMM (Prosedur, IK, Dll)
                            </div>
                        </div>
