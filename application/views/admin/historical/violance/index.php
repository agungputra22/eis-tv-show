    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-datatable">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="<?php echo site_url('historical_violance/tambah') ?>" class="btn btn-circle green btn-outline btn-sm ajaxify"> 
                    ...
                    <table class="table table-striped table-bordered table-hover" id="datatables">
                        ...
                        <tr>
                            ...
                            <td> 
                                ...
                                if ($row['status_dokumen']=='Complete') {
                                    echo "<a href='#' class='btn btn-xs btn-success ajaxify' disabled='disabled'><span class='glyphicon glyphicon-ok'></span>Complete</a> <br>";
                                } elseif ($row['status_dokumen']=='No Complete') {
                                    echo "<a href='#' class='btn btn-xs btn-danger ajaxify' disabled='disabled'><span class='glyphicon glyphicon-remove'></span>No Complete</a> <br>";
                                }
