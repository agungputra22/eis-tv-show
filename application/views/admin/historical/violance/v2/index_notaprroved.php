            ...
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="<?php echo site_url('historical_violance/index_approval_v2') ?>" class="btnList btn btn-circle green btn-outline btn-sm ajaxify"> 
                        <i class="fa fa-bars"></i> Back List Data </a>
                </div>
            </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="datatables">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                if ($row['status_hr_manager']=='1') {
                                    if ($row['perusahaan_struktur']=='TVIP') {
                                        ?>
                                        <a href='<?php echo site_url('historical_violance/violance_tvip_v2/'.$row['id_historical_violance']) ?>' target='_blank' class='btn btn-xs text-success'><i class='fa fa-print'></i> Print </a> <br>
                                        <?php
