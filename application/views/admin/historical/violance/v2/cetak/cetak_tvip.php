...
<body onload="window.print()">
    <div class="header">
        <table width="100%">
            <tr>
                <td width="70">
                    <img width="70" height="70" src="<?php echo base_url($this->config->item('img_path').'TVIP_LOGO.jpg') ?>">
                </td>
                <td align="center" class="uppercase">
                    ...
                    <small>Tlp : 021 – 5802854 / 58300607 / 58353885</small>
                </td>
                <td width="70">
                    <img width="70" height="70" src="<?php echo base_url($this->config->item('img_path').'ISO9001.png') ?>">
                </td>
            </tr>
            <tr>
                <td colspan="3"> <hr> </td>
