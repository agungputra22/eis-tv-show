...
<body onload="window.print()">
    <div class="header">
        <table width="100%">
            <tr>
                <td width="110">
                    <img width="100" height="70" src="<?php echo base_url($this->config->item('img_path').'MRT_LOGO.jpg') ?>">
                </td>
                <td align="left" class="uppercase">
                    <strong>CV. METRO RAYA TRANS</strong><br>
                    <small>Kp. Tlajung RT. 004 RW 002, Desa Wanaherang</small><br>
                    <small>Gunung Putri – Bogor, Jawa Barat</small><br>
                    <small>Telp : (021) 8686 2773 / (021) 9865 9983</small>
                </td>
                <td width="60">
                </td>
            </tr>
