...
<body onload="window.print()">
    <div class="header">
        <table width="100%">
            <tr>
                <td width="110">
                    <img width="100" height="70" src="<?php echo base_url($this->config->item('img_path').'TBK_LOGO.png') ?>">
                </td>
                <td align="left" class="uppercase">
                    <strong>CV. TERANG BERKAT KARUNIA</strong><br>
                    <small>JL. Raya Sukabumi KP. Cimande Hilir RT. 001 RW. 004</small><br>
                    <small>Cimande Hilir, Caringin – Bogor, Jawa Barat</small><br>
