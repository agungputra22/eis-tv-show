...
<body onload="window.print()">
    ...
    <table>
        ...
        <tr>
            <td class="justify">Telah melakukan tindakan yang tidak sejalan dengan kebijakan dan peraturan perusahaan berupa <b><?php echo $edit['pelanggaran_historical_violance'] ?></b> maka atas perbuatan tersebut saudara diberikan <b><?php echo $edit['punishment_historical_violance'] ?></b> yang berlaku untuk jangka waktu 3 (tiga) / 6 (enam) bulan terhitung sejak tanggal <?php echo DateToIndo(date($edit['warning_start_historical_violance'])); ?> s/d <?php echo DateToIndo(date($edit['warning_end_historical_violance'])); ?>. <br></td>
        </tr>
    </table>
    <table width="100%">
        <tr>
