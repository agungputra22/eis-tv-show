    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            ...
            <div class="portlet-body">
                <form role="form" class="form-horizontal form-performance-user-tt" method="post" action="<?php echo site_url('performance/doUpdate_tt_user') ?>">
                    <div class="form-body">
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="<?php echo site_url('performance/index_target_terukur') ?>" class="btn grey-salsa btn-outline ajaxify"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
                </form>
...
<script type="text/javascript">
    ...
    window.PERFORMANCE.handleSendDataUpdateUser();
</script>