                ...
                <div class="table-container">
                    <table class="table table-striped table-bordered table-hover" id="datatables">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <a href="<?php echo site_url('performance/detail_target_terukur?nik_baru='.$row['nik_baru'].'&bulan='.$row['bulan'].'&tahun='.$row['tahun']) ?>" class="btn btn-circle purple btn-outline btn-sm ajaxify"><i class="fa fa-book"></i>FORM IPP</a>
                            </td>
                        </tr>
                        <?php
                        $no++;
