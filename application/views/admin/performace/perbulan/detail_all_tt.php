    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            ...
            <div class="portlet-body">
                <form role="form" class="form-horizontal form-performance-update-tt" method="post" action="<?php echo site_url('performance/doUpdate_tt_perbulan') ?>">
                    <div class="form-body">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="datatables">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="number" name="persentase_atasan_a[]" class="form-control" value="<?php echo $row['persentase_atasan'] ?>">
                                </td>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="datatables_point_b">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="number" name="persentase_atasan_b[]" class="form-control" value="<?php echo $row['persentase_atasan'] ?>">
                                </td>
                                <td> <?php echo $row['persentase_user'] ?> </td>
                                <td>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="datatables_point_c">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="number" name="persentase_atasan_c[]" class="form-control" value="<?php echo $row['persentase_atasan'] ?>">
                                </td>
                                <td> <?php echo $row['persentase_user'] ?> </td>
                                <td>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="datatables_point_f">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="number" name="persentase_atasan_f[]" class="form-control" value="<?php echo $row['persentase_atasan'] ?>">
                                </td>
                                <td> <?php echo $row['persentase_user'] ?> </td>
                                <td>
