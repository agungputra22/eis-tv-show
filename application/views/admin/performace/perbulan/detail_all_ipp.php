    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            ...
            <div class="portlet-body">
                <form role="form" class="form-horizontal form-performance-update-tt" method="post" action="<?php echo site_url('performance/doUpdate_ipp_perbulan') ?>">
                    <div class="form-body">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="datatables">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="number" name="persentase_atasan_a[]" class="form-control" min="0" value="<?php echo $row['persentase_atasan'] ?>">
                                </td>
                                <td> <?php echo $row['persentase_user'] ?> </td>
                                <td>
                                    <textarea class="form-control" name="keterangan_a[]" rows="3"><?php echo $row['keterangan'] ?></textarea>
                                </td>
                            </tr>
                            <?php
                            $no++;
                        ...
                        <table class="table table-striped table-bordered table-hover" id="datatables_point_b">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="number" name="persentase_atasan_b[]" class="form-control" min="0" value="<?php echo $row['persentase_atasan'] ?>">
                                </td>
                                <td> <?php echo $row['persentase_user'] ?> </td>
                                <td>
                                    <textarea class="form-control" name="keterangan_b[]" rows="3"><?php echo $row['keterangan'] ?></textarea>
                                </td>
                            </tr>
                            <?php
                            $no++;
                        ...
                        <table class="table table-striped table-bordered table-hover" id="datatables_point_c">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="number" name="persentase_atasan_c[]" class="form-control" min="0" value="<?php echo $row['persentase_atasan'] ?>">
                                </td>
                                <td> <?php echo $row['persentase_user'] ?> </td>
                                <td>
                                    <textarea class="form-control" name="keterangan_c[]" rows="3"><?php echo $row['keterangan'] ?></textarea>
                                </td>
                            </tr>
                            <?php
                            $no++;
                        ...
                        <table class="table table-striped table-bordered table-hover" id="datatables_point_d">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="number" name="persentase_atasan_d[]" class="form-control" min="0" value="<?php echo $row['persentase_atasan'] ?>">
                                </td>
                                <td> <?php echo $row['persentase_user'] ?> </td>
                                <td>
                                    <textarea class="form-control" name="keterangan_d[]" rows="3"><?php echo $row['keterangan'] ?></textarea>
                                </td>
                            </tr>
                            <?php
                            $no++;
                        ...
                        <table class="table table-striped table-bordered table-hover" id="datatables_point_e">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="number" name="persentase_atasan_e[]" class="form-control" min="0" value="<?php echo $row['persentase_atasan'] ?>">
                                </td>
                                <td> <?php echo $row['persentase_user'] ?> </td>
                                <td>
                                    <textarea class="form-control" name="keterangan_e[]" rows="3"><?php echo $row['keterangan'] ?></textarea>
                                </td>
                            </tr>
                            <?php
                            $no++;
                        ...
                        <table class="table table-striped table-bordered table-hover" id="datatables_point_f">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="number" name="persentase_atasan_f[]" class="form-control" min="0" value="<?php echo $row['persentase_atasan'] ?>">
                                </td>
                                <td> <?php echo $row['persentase_user'] ?> </td>
                                <td>
                                    <textarea class="form-control" name="keterangan_f[]" rows="3"><?php echo $row['keterangan'] ?></textarea>
                                </td>
                            </tr>
                            <?php
                            $no++;
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="<?php echo site_url('performance/index_perbulan') ?>" class="btn grey-salsa btn-outline ajaxify"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
                </form>
...
<script type="text/javascript">
    ...
    window.PERFORMANCE.handleSendDataUpdateTT();
</script>