                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">Persentase (%)</label>
                                <div class="col-md-1">
                                    <input type="text" name="persentase_d" class="form-control input-circle" readonly value="<?php echo $persentase_d['bobot'] ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">Persentase (%)</label>
                                <div class="col-md-1">
                                    <input type="text" name="persentase_e" class="form-control input-circle" readonly value="<?php echo $persentase_e['bobot'] ?>">
                                </div>
                            </div>
                        </div>
