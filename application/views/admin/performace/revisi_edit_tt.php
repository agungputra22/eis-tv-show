    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            ...
            <div class="portlet-body">
                <form role="form" class="form-horizontal form-performance" method="post" action="<?php echo site_url('performance/doUpdate_tt') ?>">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-1">
                                    ...
                                    <input type="hidden" name="status_a" id="status_a" class="form-control input-circle" value="2">
                                </div>
                                <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-1">
                                    ...
                                    <input type="hidden" name="status_b" id="status_b" class="form-control input-circle" value="2">
                                </div>
                                <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-1">
                                    ...
                                    <input type="hidden" name="status_c" id="status_c" class="form-control input-circle" value="2">
                                </div>
                                <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-1">
                                    ...
                                    <input type="hidden" name="status_f" id="status_f" class="form-control input-circle" value="2">
                                </div>
                                <div class="col-md-2">
    ...
    <form class="form-horizontal">
        <div class="modal-body"> 
            ...
            <div class="form-group">
                ...
                <div class="col-xs-9">
                    <select class="form-control" name="evaluasi_a" id="evaluasi_a">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        function tampil_data_point_a(){
            ...
            $.ajax({
                type  : 'GET',
                url   : '<?=base_url('performance/data_all_tt_a')?>',
                async : true,
                dataType : 'json',
...
        });
        ...
        function tampil_data_point_b(){
            ...
            $.ajax({
                type  : 'GET',
                url   : '<?=base_url('performance/data_all_tt_b')?>',
                async : true,
                dataType : 'json',
                data : {nik_baru:nik_baru},
                success : function(data){
...
        });
        ...
        function tampil_data_point_c(){
            ...
            $.ajax({
                type  : 'GET',
                url   : '<?=base_url('performance/data_all_tt_c')?>',
                async : true,
                dataType : 'json',
                data : {nik_baru:nik_baru},
                success : function(data){
...
        });
        ...
        function tampil_data_point_f(){
            ...
            $.ajax({
                type  : 'GET',
                url   : '<?=base_url('performance/data_all_tt_f')?>',
                async : true,
                dataType : 'json',
                data : {nik_baru:nik_baru},
                success : function(data){
