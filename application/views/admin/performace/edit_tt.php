    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            ...
            <div class="portlet-body">
                <form role="form" class="form-horizontal form-performance" method="post" action="<?php echo site_url('performance/doInput_tt') ?>">
                    <div class="form-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){      
      var postURL = "<?=base_url('performance/doInput_tt')?>";
      var i=1;  
