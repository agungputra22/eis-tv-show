    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-datatable">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="<?php echo site_url('piutang/tambah') ?>" class="btn btn-circle green btn-outline btn-sm ajaxify"> 
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                if ($row['status_fa']=='0') {
                                    ...
                                    <button class="btn btn-xs btn-warning" disabled>OPEN</button>
                                    <?php
                                } elseif ($row['status_fa']=='1') {
                                    ?>
                                    <button class="btn btn-xs btn-primary" disabled><span class='glyphicon glyphicon-ok'></span> APPROVE</button>
                                    <?php
                                } elseif ($row['status_fa']=='2') {
                                    ?>
                                    <button class="btn btn-xs btn-danger" disabled><span class='glyphicon glyphicon-remove'></span> NOT APPROVE</button>
                                    <?php
                                } else {
                            ...
                            <td align="center">
                                ...
                                if ($row['status_far']=='1') {
                                    ?>
                                    <a href="<?php echo site_url('piutang/print_far/'.$row['id']) ?>" target="_blank" class="btn btn-xs text-success"><i class="fa fa-print"></i> Print FAR </a> <br>
                                    <a href="<?php echo site_url('piutang/print_far_detail/'.$row['id']) ?>" target="_blank" class="btn btn-xs text-success"><i class="fa fa-print"></i> Print Detail </a>
                                    <?php
                                }
                            ...
                            <td align="center">
                                ...
                                if ($row['status_far']=='0') {
                                    ?>
                                    <a href="<?php echo site_url('piutang/edit/'.$row['id']) ?>" class="text-primary ajaxify"><i class="fa fa-pencil"> Edit</i></a> &nbsp;
                                    <?php
                                }
                                ?>
                            </td>
