    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            ...
            <div class="portlet-body">
                <form role="form" class="form-horizontal form-piutang-detail" method="post" action="<?php echo site_url('piutang/doInput') ?>">
                    <div class="form-body">
                        <div class="form-group">
                            <div class="col-md-4">
                                <input type="hidden" name="id_piutang" class="form-control" placeholder="Enter Id piutang" readonly="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="no_pengajuan" id="no_pengajuan" class="form-control" placeholder="Enter No" value="<?php echo 'FAR-PIUTANG-'.$pengajuan;?>" required readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="date" name="tanggal_far" class="form-control" placeholder="Enter Tanggal" required="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="nominal" id="nominal" class="form-control" placeholder="Enter Nominal" required="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select name="type" id="type" class="form-control" required="">
                                    ...
                                    <option value="Piutang Karyawan">Piutang Karyawan</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <textarea name="keterangan" class="form-control" placeholder="Enter Keterangan" rows="4" required></textarea>
                            </div>
                        </div>
    ...
    <form class="form-horizontal">
        <div class="modal-body"> 
            <div class="form-group">
                ...
                <div class="col-xs-9">
                    <input name="no_far" id="no_far" class="form-control" type="text" placeholder="No. Pesanan" value="<?php echo 'FAR-PIUTANG-'.$pengajuan;?>" required readonly>
                </div>
            </div>
    ...
    <form class="form-horizontal">
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-4">
                    <input type="number" name="piutang_edit" id="piutang_edit" class="form-control" placeholder="" min="0">
                </div>
