                        ...
                        <tbody>
                            ...
                            ?>
                                <div class="actions" align="right">
                                    <a href="<?php echo site_url('karyawan/edit/'.$row['nik_baru']) ?>" class="text-primary ajaxify">
                                        <i class="fa fa-pencil">Edit Data</i></a>
                                </div>
                                <tr>
                                    <td rowspan="6" width="250" height="250"><center> <img width="250" height="250" src="../hris/uploads/data_induk/foto/<?=$row['foto'];?>" /> </center> </td>
                                    <td>NIK</td> <td>:</td> <td><?php echo $row['nik_baru'] ?></td>
                                </tr>
                                <tr>
                                    <td>Nama</td> <td>:</td> <td><?php echo $row['nama_lengkap'] ?></td>
                                </tr>
                                <tr>
                                    <td>Jabatan</td> <td>:</td> <td><?php echo $row['jabatan_karyawan'] ?></td>
                                </tr>
                                <tr>
                                    <td>Departement</td> <td>:</td> <td><?php echo $row['dept_struktur'] ?></td>
                                </tr>
                                <tr>
                                    <td>Tanggal Masuk</td> <td>:</td> <td><?php echo DateToIndo(date($row['join_date_struktur'])); ?></td>
                                </tr>
                                <tr>
                                    <td>Status Karyawan</td> <td>:</td> <td><?php echo $row['status_karyawan_struktur'] ?></td>
                                </tr>
                            <?php
                            $no++;
                            }
