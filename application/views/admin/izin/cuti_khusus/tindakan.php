    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            ...
            <div class="portlet-body">
                <form role="form" class="form-horizontal form-cuti_khusus" method="post" action="<?php echo site_url('cuti_khusus/doUpdate') ?>">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="radio" name="status_cuti_khusus" value="1" required="">Approved
                                <input type="radio" name="status_cuti_khusus" value="2">Not Approved
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" name="feedback_cuti_khusus" required=""></textarea>
                                <input type="hidden" name="tanggal_approval_cuti_khusus" value="<?php echo date('Y-m-d'); ?>">
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-9">
                                ...
                                <a href="<?php echo site_url('cuti_khusus/approve') ?>" class="btn grey-salsa btn-outline ajaxify"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
                </form>
