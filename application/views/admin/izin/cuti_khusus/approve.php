        ...
        <div class="portlet light portlet-fit portlet-datatable">
            ...
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <a href="<?php echo site_url('cuti_khusus/view_approve_level_1') ?>" class="btn btn-circle green btn-outline btn-sm ajaxify"> 
                        <i class="fa fa-warning"></i>Approved (<?php echo $approve; ?>) 
                    </a>
                    <a href="<?php echo site_url('cuti_khusus/view_not_approve_level_1') ?>" class="btn btn-circle red btn-outline btn-sm ajaxify"> 
                        <i class="fa fa-warning"></i>Not Approved (<?php echo $not_approve; ?>) 
                    </a>
                    <a href="<?php echo site_url('cuti_khusus/view_hangus_level_1') ?>" class="btn btn-circle red btn-outline btn-sm ajaxify"> 
                ...
                <div class="table-container">
                    <table class="table table-striped table-bordered table-hover" id="datatables">
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;<?php if ($row['status_cuti_khusus']=='1') { ?> <?php } ?>">
                              <?php if ($row['status_cuti_khusus']=='0') {?>
