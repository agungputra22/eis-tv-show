    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            ...
            <div class="portlet-body">
                <form role="form" class="form-horizontal form-cuti_tahunan" method="post" action="<?php echo site_url('cuti_tahunan/doUpdate_level_2') ?>">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="end_cuti_tahunan" class="form-control" placeholder="Enter Kode" required="required" readonly="" value="<?php echo $edit['opsi_cuti_tahunan'] ?>">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-md-3 control-label">FeedBack Atasan 1
                            <span class="font-red">*</span>
                            </label>
                            <div class="col-md-4">
                                <textarea class="form-control" name="feedback_cuti_tahunan" readonly=""><?php echo $edit['feedback_cuti_tahunan'] ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="radio" name="status_cuti_tahunan_2" value="1" required="">Approved
                                <input type="radio" name="status_cuti_tahunan_2" value="2">Not Approved
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <textarea class="form-control" name="feedback_cuti_tahunan_2" required=""></textarea>
                                <input type="hidden" name="tanggal_cuti_tahunan_2" value="<?php echo date('Y-m-d'); ?>">
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="<?php echo site_url('cuti_tahunan/approve_level_2') ?>" class="btn grey-salsa btn-outline ajaxify"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
                </form>
