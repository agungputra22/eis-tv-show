    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            ...
            <div class="portlet-body">
                <form role="form" class="form-horizontal form-manual_absen" method="post" action="<?php echo site_url('manual_absen/doUpdate_level_2') ?>">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="radio" name="status_2" value="1" required="">Approved
                                <input type="radio" name="status_2" value="2">Not Approved
                                <input type="hidden" name="tanggal_2" value="<?php echo date('Y-m-d'); ?>">
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="<?php echo site_url('manual_absen/approve_level_2') ?>" class="btn grey-salsa btn-outline ajaxify"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
                </form>
