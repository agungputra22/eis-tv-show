        ...
        <div class="portlet light portlet-fit portlet-datatable">
            ...
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <a href="<?php echo site_url('manual_absen/view_approve_level_1') ?>" class="btn btn-circle green btn-outline btn-sm ajaxify"> 
                        <i class="fa fa-warning"></i>Approved (<?php echo $approve; ?>) 
                    </a>
                    <a href="<?php echo site_url('manual_absen/view_not_approve_level_1') ?>" class="btn btn-circle red btn-outline btn-sm ajaxify"> 
