    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-datatable">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject font-dark sbold uppercase"><?php echo $title ?></span> &nbsp; &nbsp; <br>
                    <h5><span class="font-red">Note : Hanya Dilakukan dalam keadaan terminal absen rusak atau mati listrik</span></h5>
                </div>
                <div class="actions">
                    <a href="<?php echo site_url('manual_absen/tambah') ?>" class="btn btn-circle green btn-outline btn-sm ajaxify"> 
                        <i class="fa fa-plus"></i> Form Absen Manual (FRM.HRD.49) </a>
                </div>
            </div>
