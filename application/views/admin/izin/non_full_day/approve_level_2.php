        ...
        <div class="portlet light portlet-fit portlet-datatable">
            ...
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <a href="<?php echo site_url('non_full_day/view_approve_level_2') ?>" class="btn btn-circle green btn-outline btn-sm ajaxify"> 
                        <i class="fa fa-warning"></i>Approved (<?php echo $approve; ?>) 
                    </a>
                    <a href="<?php echo site_url('non_full_day/view_not_approve_level_2') ?>" class="btn btn-circle red btn-outline btn-sm ajaxify"> 
                    ...
                    <table class="table table-striped table-bordered table-hover" id="datatables">
                        ...
                        <tr>
                            ...
                            <?php if ($row['level_role']=='1'): ?>
                                <td style="text-align:center;<?php if ($row['status_non_full_2']=='1') { ?> <?php } ?>">
                                  <?php if ($row['status_non_full_2']=='0') {?>
                                    <a href="<?php echo site_url('non_full_day/edit/'.$row['id_non_full']) ?>" class="text-primary ajaxify"><i class="fa fa-pencil"></i>Approval</a> &nbsp;
                                  <?php } ?>
                                </td>
                            <?php elseif ($row['level_role']=='2'): ?>
                                <td style="text-align:center;<?php if ($row['status_non_full_2']=='1') { ?> <?php } ?>">
                                  <?php if ($row['status_non_full_2']=='0') {?>
                                    <a href="<?php echo site_url('non_full_day/edit_level_2/'.$row['id_non_full']) ?>" class="text-primary ajaxify"><i class="fa fa-pencil"></i>Approval</a> &nbsp;
                                  <?php } ?>
                                </td>
                            <?php endif ?>
