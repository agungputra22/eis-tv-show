        ...
        <div class="portlet light portlet-fit portlet-datatable">
            ...
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <a href="<?php echo site_url('dinas_full_day/view_approve_level_1') ?>" class="btn btn-circle green btn-outline btn-sm ajaxify"> 
                        <i class="fa fa-warning"></i>Approved (<?php echo $approve; ?>) 
                    </a>
                    <a href="<?php echo site_url('dinas_full_day/view_not_approve_level_1') ?>" class="btn btn-circle red btn-outline btn-sm ajaxify"> 
                        <i class="fa fa-warning"></i>Not Approved (<?php echo $not_approve; ?>) 
                    </a>
                    <a href="<?php echo site_url('dinas_full_day/view_hangus_level_1') ?>" class="btn btn-circle red btn-outline btn-sm ajaxify"> 
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                    ...
                                    <a href="<?php echo base_url('dinas_full_day/download/'.$row['id_full_day']) ?>">Download file</a>
                                    <?php
                                    } else {
                                        echo "Tidak Ada File";
                                    }
                            ...
                            <td style="text-align:center;<?php if ($row['status_full_day']=='1') { ?> <?php } ?>">
                              <?php if ($row['status_full_day']=='0') {?>
                                <a href="<?php echo site_url('dinas_full_day/edit/'.$row['id_full_day']) ?>" class="text-primary ajaxify"><i class="fa fa-pencil"></i>Approval</a> &nbsp;
                              <?php } ?>
                            </td>
                        </tr>
                        <?php
