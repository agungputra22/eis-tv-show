    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="<?php echo site_url('full_day/index_mechanical') ?>" class="btnList btn btn-circle green btn-outline btn-sm ajaxify"> 
                        ...
                        <div class="collapse" id="urgent">
                            <div class="card card-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="file" name="upload_full_day_cd" class="form-control" placeholder="Enter Tanggal">
                                    </div>
                                    <!-- <div class="col-md-4">
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="<?php echo site_url('full_day/index_mechanical') ?>" class="btn grey-salsa btn-outline ajaxify"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
                </form>
