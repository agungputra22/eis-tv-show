        ...
        <div class="portlet light portlet-fit portlet-datatable">
            ...
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <a href="<?php echo site_url('full_day/view_approve_level_2') ?>" class="btn btn-circle green btn-outline btn-sm ajaxify"> 
                        <i class="fa fa-warning"></i>Approved (<?php echo $approve; ?>) 
                    </a>
                    <a href="<?php echo site_url('full_day/view_not_approve_level_2') ?>" class="btn btn-circle red btn-outline btn-sm ajaxify"> 
                        <i class="fa fa-warning"></i>Not Approved (<?php echo $not_approve; ?>) 
                    </a>
                    <!-- <a href="<?php echo site_url('full_day/notifikasi_level_2') ?>" class="btn btn-circle yellow btn-outline btn-sm ajaxify"> 
                        <i class="fa fa-warning"></i>Notifikasi Approval (<?php echo $notifikasi; ?>) 
                    </a> -->
                </div>
