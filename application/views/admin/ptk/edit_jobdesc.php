    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            ...
            <div class="portlet-body">
                <form role="form" class="form-horizontal form-ptk" method="post" action="<?php echo site_url('ptk/doInput_jobdesc') ?>">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            &nbsp; &nbsp; &nbsp; <label class="control-label"><b>1. TUGAS DAN TANGGUNG JAWAB</b></label><br>
                        ...
                        <table class="table table-bordered" id="dynamic_field_tugas_tanggung_jawab">
                            <tr role="row" class="bg-primary">
                                <td align="center" width="25"> <button type="button" name="add_tugas_tanggung_jawab" id="add_tugas_tanggung_jawab" class="btn btn-success">+</button> </td>
                                <td align="center"> Keterangan </td>
                            </tr>
                        </table>
                        <br><br>
                        <div class="form-group">
                            &nbsp; &nbsp; &nbsp; <label class="control-label"><b>2. WEWENANG</b></label> <br>
                        ...
                        <table class="table table-bordered" id="dynamic_field_wewenang">
                            <tr role="row" class="bg-primary">
                                <td align="center" width="25"> <button type="button" name="add_wewenang" id="add_wewenang" class="btn btn-success">+</button> </td>
                                <td align="center"> Keterangan </td>
                            </tr>
                        </table>
                        <br><br>
                        <div class="form-group">
                            ...
                            &nbsp; &nbsp; &nbsp; <b>Internal Perusahaan</b> (Didalam lingkungan PT. TVIP & Strategic Business Unit / SBU )
                        </div>
                        <table class="table table-bordered" id="dynamic_field_kerja_internal">
                            <tr role="row" class="bg-primary">
                                <td align="center" width="25"> <button type="button" name="add_kerja_internal" id="add_kerja_internal" class="btn btn-success">+</button> </td>
                                <td align="center"> Berhubungan Dengan Pihak </td>
                                <td align="center"> Tujuan Dalam Berhubungan </td>
                            </tr>
                        </table>
                        <br><br>
                        <div class="form-group">
                            &nbsp; &nbsp; &nbsp; <b>Eksternal Perusahaan</b> (Didalam lingkungan PT. TVIP & Strategic Business Unit / SBU )
                        </div>
                        <table class="table table-bordered" id="dynamic_field_kerja_eksternal">
                            <tr role="row" class="bg-primary">
                                <td align="center" width="25"> <button type="button" name="add_kerja_eksternal" id="add_kerja_eksternal" class="btn btn-success">+</button> </td>
                                <td align="center"> Berhubungan Dengan Pihak </td>
                                <td align="center"> Tujuan Dalam Berhubungan </td>
                            </tr>
                        </table>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>Harian</td>
                                <td><textarea class="form-control" name="laporan_harian" placeholder="Enter"></textarea></td>
                                <td><textarea class="form-control" name="kepada_harian" placeholder="Enter"></textarea></td>
                            </tr>
                            <tr>
                                <td>Bulanan</td>
                                <td><textarea class="form-control" name="laporan_bulanan" placeholder="Enter"></textarea></td>
                                <td><textarea class="form-control" name="kepada_bulanan" placeholder="Enter"></textarea></td>
                            </tr>
                            <tr>
                                <td>Tahunan</td>
                                <td><textarea class="form-control" name="laporan_tahunan" placeholder="Enter"></textarea></td>
                                <td><textarea class="form-control" name="kepada_tahunan" placeholder="Enter"></textarea></td>
                            </tr>
                        </table>
                        <br><br>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control input-circle" placeholder="Enter text" name="pendidikan" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">NILAI RATA-RATA / IPK (MINIMAL)</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control input-circle" placeholder="Enter text" name="nilai" required>
                            </div>
                        </div>
                        <div class="form-group">
                            &nbsp; &nbsp; &nbsp; <b>PENGALAMAN</b>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control input-circle" placeholder="Enter text" name="pengalaman_lulus" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">Jurusan sesuai dengan bidang pekerjaan</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control input-circle" placeholder="Enter text" name="pengalaman_sesuai" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">Jurusan tidak sesuai dengan bidang pekerjaan</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control input-circle" placeholder="Enter text" name="pengalaman_tidak_sesuai" required>
                            </div>
                        </div>
                        <br>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control input-circle" placeholder="Enter text" name="jenis_kelamin" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">USIA</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control input-circle" placeholder="Enter text" name="usia" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">KEAHLIAN/PENGATAHUAN KHUSUS</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control input-circle" placeholder="Enter text" name="keahlian">
                            </div>
                        </div>
                        <br><br>
                        <div class="form-group">
                        ...
                        <br>
                        <div class="form-group">
                            &nbsp; &nbsp; &nbsp; <label class="control-label"><b>HARD COMPETENCY</b></label><br>
                        ...
                        <table class="table table-bordered" id="dynamic_field_hard">
                            <tr role="row" class="bg-primary">
                                <td align="center" width="25"> <button type="button" name="add_hard" id="add_hard" class="btn btn-success">+</button> </td>
                                <td align="center"> Keterangan </td>
                        ...
                        <br><br>
                        <div class="form-group">
                            &nbsp; &nbsp; &nbsp; <label class="control-label"><b>SOFT COMPETENCY</b></label><br>
                        ...
                        <table class="table table-bordered" id="dynamic_field_soft">
                            <tr role="row" class="bg-primary">
                                <td align="center" width="25"> <button type="button" name="add_soft" id="add_soft" class="btn btn-success">+</button> </td>
                                <td align="center"> Keterangan </td>
                                <td align="center"> Level </td>
                            </tr>
                        </table>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="<?php echo site_url('ptk/index_jobdesc') ?>" class="btn grey-salsa btn-outline ajaxify"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
                </form>
