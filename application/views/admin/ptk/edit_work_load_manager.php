            ...
            <div class="portlet-body">
                <form role="form" class="form-horizontal form-ptk" method="post" action="<?php echo site_url('ptk/doInput_work_load') ?>">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">Alur Proses per Jabatan</label>
                        </div>
                        <table class="table table-bordered" id="dynamic_field_anak">
                            ...
                            <tr>
                                <td>
                                    <textarea class="form-control" name="input[]" placeholder="Enter" rows="3"></textarea>
                                </td>
                                <td>
                                    <textarea class="form-control" name="proses[]" placeholder="Enter" rows="3"></textarea>
                                </td>
                                <td>
                                    <textarea class="form-control" name="output[]" placeholder="Enter" rows="3"></textarea>
                                </td>
                                <td>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Analisa Beban Kerja (DAILY BASIC)</label>
                        </div>
                        <table class="table table-bordered" id="dynamic_field_analisa">
                            <tr role="row" class="bg-primary">
                                <td> Detail Job Description </td>
                                <td> Hour </td>
                                <td> Remarks </td>
                                <td> AKSI </td>
                            </tr>
                            <tr>
                                <td>
                                    <textarea class="form-control" name="detail_deskripsi[]" placeholder="Enter" rows="3"></textarea>
                                </td>
                                <td>
                                    <textarea class="form-control" name="jam[]" placeholder="Enter" rows="3"></textarea>
                                </td>
                                <td>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Analisa Beban Kerja (WEEKLY BASIC)</label>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Analisa Beban Kerja (MONTYLY BASIC)</label>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">Resiko Kerja</label>
                        </div>
                        <table class="table table-bordered" id="dynamic_field_resiko_kerja">
                            <tr role="row" class="bg-primary">
                                <td> Nama Penyakit / Jenis Kecelakaan Kerja </td>
                                <td> Saat melakukan mobile recruitment </td>
                                <td> AKSI </td>
                            </tr>
                            <tr>
                                <td>
                                    <textarea class="form-control" name="nama_penyakit[]" placeholder="Enter" rows="3"></textarea>
                                </td>
                                <td>
                                    <textarea class="form-control" name="penyebab[]" placeholder="Enter" rows="3"></textarea>
                                </td>
                                <td>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <a href="<?php echo site_url('ptk/index_work_load_manager') ?>" class="btn grey-salsa btn-outline ajaxify"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
                </form>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){      
      ...
      $('#add_analisa_mingguan').click(function(){  
           i++;  
           $('#dynamic_field_analisa_mingguan').append('<tr id="row_mingguan'+i+'" class="dynamic-added_analisa_mingguan"><td><textarea class="form-control" name="detail_deskripsi[]" placeholder="Enter" rows="3"></textarea></td><td><textarea class="form-control" name="jam[]" placeholder="Enter" rows="3"></textarea></td><td><textarea class="form-control" name="keterangan[]" placeholder="Enter" rows="3"></textarea><input type="hidden" name="status[]" value="2"></td><td><div><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove_mingguan">X</button></div></td></tr>');  
      });
    ...
    $(document).ready(function(){      
      ...
      $('#add_analisa_bulanan').click(function(){  
           i++;  
           $('#dynamic_field_analisa_bulanan').append('<tr id="row_bulanan'+i+'" class="dynamic-added_analisa_bulanan"><td><textarea class="form-control" name="detail_deskripsi[]" placeholder="Enter" rows="3"></textarea></td><td><textarea class="form-control" name="jam[]" placeholder="Enter" rows="3"></textarea></td><td><textarea class="form-control" name="keterangan[]" placeholder="Enter" rows="3"></textarea></td><input type="hidden" name="status[]" value="3"><td><div><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove_bulanan">X</button></div></td></tr>');  
      });
