                        ...
                        <tr>
                            ...
                            <?php
                                if ($row['status_mpp'] == '0') {
                                    ...
                                    ?>
                                    <td align="center"> <a href="#" class="btn btn-xs btn-primary ajaxify" disabled="disabled"><span class="glyphicon glyphicon-ok">CLOSE</span></a> </td>
                                    <?php
                                }
                            ?>
                            ...
                            <?php
                                if ($row['status_wla'] == '0') {
                                    ...
                                    ?>
                                    <td align="center">
                                        <a href="<?php echo site_url('ptk/edit_work_load/'.$row['no_jabatan_karyawan']) ?>" class="btn btn-xs btn-danger ajaxify"><i class="fa fa-pencil"></i>Update WLA</a> &nbsp;
                                    </td>
                                    <?php
                                }
                            ?>
