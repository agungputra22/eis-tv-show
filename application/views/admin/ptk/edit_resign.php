    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            ...
            <div class="portlet-body">
                <form role="form" class="form-horizontal form-ptk" method="post" action="<?php echo site_url('ptk/doInput_resign') ?>">
                    <div class="form-body">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <?php
                                // $hasil = $edit['MPA'] - $edit['MPP'];
                                $hasil = $edit['MPA'] - $edit['MPP_ACC'];
                                for ($i = 1; $i <= $hasil; $i++) {
                                    ?>
                                    <tr>
                                        <td>
