    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="<?php echo site_url('karyawan_project/index_tkbm') ?>" class="btnList btn btn-circle green btn-outline btn-sm ajaxify"> 
                        <i class="fa fa-bars"></i> List Data </a>
                </div>
            </div>
            <div class="portlet-body">
                <form name="input_bahasa" id="input_bahasa" role="form" class="form-horizontal form-karyawan_project" method="post" action="<?php echo site_url('karyawan_project/doInput_tkbm') ?>" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    function getFormDataKaryawan(x) {
        ...
        $.ajax({
            url: "<?= base_url('karyawan_project/getFormDataKaryawan_tkbm') ?>",
            method: "POST",
            data: {
                nik_absen: nik_absen,
            },
