    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            ...
            <div class="portlet-body">
                <form role="form" class="form-horizontal form-resign" method="post" action="<?php echo site_url('resign/doUpdate_atasan_2') ?>">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="tanggal_efektif_resign" class="form-control" placeholder="Enter Kode" required="required" readonly="" value="<?php echo $edit['tanggal_efektif_resign'] ?>" min="<?php echo date('Y-m-d', strtotime('+1 month', strtotime(date('Y-m-d')))); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="radio" name="status_atasan_2" value="1" required>Approved
                                <input type="radio" name="status_atasan_2" value="2">Not Approved
                            </div>
                        </div>
...
<script type="text/javascript">
    window.RESIGN.handleSendData_Approve2();
</script>