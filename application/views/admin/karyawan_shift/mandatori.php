            ...
            <div class="portlet-body">
                <form role="form" class="form-horizontal form-karyawan_shift" method="post" action="<?php echo site_url('karyawan_shift/doInput') ?>">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Pilih Tanggal Tertentu 
                            ...
                            <div class="col-md-4">
                                ...
                                if ($hari == 'Friday') {
                                    ?>
                                    <input required="required" type="date" name="tanggal_shift" class="form-control" title="Choose your desired date" min="<?php echo date('Y-m-d', strtotime('+3 days', strtotime(date('Y-m-d')))); ?>" max="<?php echo date('Y-m-d', strtotime('+9 days', strtotime(date('Y-m-d')))); ?>"/>
                                    <?php
                            ...
                            <label class="col-md-1 control-label"><span class="font-red">Atau</span>
                            
                            </label>

                            <div class="col-md-4">
                                <a href="<?php echo site_url('karyawan_shift/range_tanggal') ?>" class="btnList btn btn-circle green btn-outline btn-sm ajaxify"> 
                                    <i class="fa fa-calendar"></i> Beberapa Tanggal </a>
                            </div>
                        </div>
