    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="<?php echo site_url('karyawan_shift/mandatori_permintaan') ?>" class="btnList btn btn-circle green btn-outline btn-sm ajaxify"> 
                ...
                <form role="form" class="form-horizontal form-karyawan_shift" method="post" action="<?php echo site_url('karyawan_shift/doInput_range') ?>">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="date" name="tanggal_awal" class="form-control" required="" placeholder="Enter Tanggal">
                            ...
                            <div class="col-md-3">
                                <input type="date" name="tanggal_akhir" class="form-control" required="" placeholder="Enter Tanggal">
