                ...
                <div class="table-container">
                    <table class="table table-striped table-bordered table-hover" id="datatables">
                        ...
                        <tr>
                            ...
                            <td> <?php echo $row['lokasi_karyawan_shift'] ?> </td>
                            <td> <?php echo $row['dept_karyawan_shift'] ?> </td>
                            <td align="center">
                                <a href="<?php echo site_url('karyawan_shift/detail_shift_sd/'.$row['nik_shift']) ?>" class="text-primary ajaxify"><i class="fa fa-eye">View Shift</i></a> &nbsp;
                            </td>
                        </tr>
                        <?php
                        $no++;
