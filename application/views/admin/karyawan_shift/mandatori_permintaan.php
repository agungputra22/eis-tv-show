                ...
                <form role="form" class="form-horizontal form-karyawan_shift" method="post" action="<?php echo site_url('karyawan_shift/doInput') ?>">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="date" name="tanggal_shift" class="form-control" placeholder="Enter Tanggal">
                            ...
                            <div class="col-md-4">
                                <a href="<?php echo site_url('karyawan_shift/range_tanggal_permintaan') ?>" class="btnList btn btn-circle green btn-outline btn-sm ajaxify"> 
