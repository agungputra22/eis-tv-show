    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="<?php echo site_url('karyawan_shift/range_tanggal_crl') ?>" class="btnList btn btn-circle green btn-outline btn-sm ajaxify"> 
                        <i class="fa fa-calendar"></i> Range Tanggal </a>
                </div>
            </div>
