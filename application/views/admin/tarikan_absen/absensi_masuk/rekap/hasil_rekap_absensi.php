    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-datatable">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="<?php echo site_url('tarikan_absen/tarikan_absen_excel_rekap_absen?nik='.$nik.'&tanggal1='.$tanggal1.'&tanggal2='.$tanggal2.'&depo='.$depo.'&jabatan='.$jabatan.'&dept='.$dept) ?>" target="_blank" class="btn btn-circle green btn-outline btn-sm"> 
                        <i class="icon-printer"></i> Rekap Absen </a>
