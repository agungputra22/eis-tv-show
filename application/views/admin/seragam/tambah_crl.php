    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="<?php echo site_url('seragam/index_crl') ?>" class="btnList btn btn-circle green btn-outline btn-sm ajaxify"> 
                        <i class="fa fa-bars"></i> List Data </a>
                </div>
            </div>
            <div class="portlet-body">
                <form role="form" class="form-horizontal form-seragam" method="post" action="<?php echo site_url('seragam/doInput') ?>">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <!-- <input type="text" name="ket_pengajuan" class="form-control" placeholder="Enter Keterangan"> -->
                                <select name="ket_pengajuan" class="form-control" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="hidden" name="kode_jabatan" class="form-control" placeholder="Enter Jabatan" readonly="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="hidden" name="harga_satuan" class="form-control" placeholder="Enter Kode Seragam" readonly="">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-md-3 control-label">Maksimal Pengajuan 
                            
                            </label>
                            <div class="col-md-4">
                                <input type="text" name="qty_seragam_max" class="form-control" placeholder="Enter QTY Seragam" readonly="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <!-- <input type="text" name="qty_seragam" class="form-control" placeholder="Enter QTY Seragam" required=""> -->
            ...
            $.ajax({
                ...
                success:function(data){
                    $.each(data, function(index, value){
                        ...
                        $("input[name='kode_jabatan']").val(value.no_jabatan_karyawan);
            ...
            $.ajax({
                ...
                success:function(data){
                    $.each(data, function(index, value){
                        ...
                        $("input[name='qty_seragam_max']").val(value.qty_seragam);
                    });
                },
            });
          }
